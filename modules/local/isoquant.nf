process ISOQUANT {
    ...
    output:
    tuple val(meta), path("*/*/*.read_assignments.tsv.gz"),              emit: read_assignments,                optional: true
    ...
    tuple val(meta), path("*/*/*.gene_grouped*_tpm.tsv"),                emit: grouped_gene_tpm
    tuple val(meta), path("*/*/*.gene_grouped*_counts.tsv"),             emit: grouped_gene_counts
    tuple val(meta), path("*/*/*.transcript_grouped*_tpm.tsv"),          emit: grouped_transcript_tpm
    tuple val(meta), path("*/*/*.transcript_grouped*_counts.tsv"),       emit: grouped_transcript_counts
    tuple val(meta), path("*/*/*.exon_grouped*_counts.tsv"),             emit: grouped_exon_counts,             optional: true
    tuple val(meta), path("*/*/*.intron_grouped*_counts.tsv"),           emit: grouped_intron_counts,           optional: true
    tuple val(meta), path("*/*/*.transcript_models.gtf"),                emit: transcript_models
    ...
    tuple val(meta), path("*/*/*.extended_annotation.gtf"),              emit: extended_gtf
    tuple val(meta), path("*/*/*.transcript_model_grouped*_counts.tsv"), emit: grouped_transcript_model_counts, optional: true
    tuple val(meta), path("*/*/*.transcript_model_grouped*_tpm.tsv"),    emit: grouped_transcript_model_tpm,    optional: true
